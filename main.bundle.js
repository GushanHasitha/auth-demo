...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http_testing__ = __webpack_require__("./node_modules/@angular/http/@angular/http/testing.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_fake_backend__ = __webpack_require__("./src/app/helpers/fake-backend.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__no_access_no_access_component__ = __webpack_require__("./src/app/no-access/no-access.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_admin_auth_guard_service__ = __webpack_require__("./src/app/services/admin-auth-guard.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_16__no_access_no_access_component__["a" /* NoAccessComponent */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__angular_router__["a" /* RouterModule */].forRoot([
                { path: '', component: __WEBPACK_IMPORTED_MODULE_11__home_home_component__["a" /* HomeComponent */] },
                {
                    ...
                    canActivate: [__WEBPACK_IMPORTED_MODULE_17__services_auth_guard_service__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_18__services_admin_auth_guard_service__["a" /* AdminAuthGuard */]]
                },
                { path: 'login', component: __WEBPACK_IMPORTED_MODULE_12__login_login_component__["a" /* LoginComponent */] },
                { path: 'no-access', component: __WEBPACK_IMPORTED_MODULE_16__no_access_no_access_component__["a" /* NoAccessComponent */] }
            ])
        ],
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_18__services_admin_auth_guard_service__["a" /* AdminAuthGuard */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__helpers_fake_backend__["a" /* fakeBackendProvider */],
...
function fakeBackendFactory(backend, options) {
    var token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJhZG1pbiI6dHJ1ZX0.F-cvL2RcfQhUtCavIM7q7zYE8drmj2LJk0JRkrS6He4';
    backend.connections.subscribe(function (connection) {
        ...
        setTimeout(function () {
            ...
            if (connection.request.url.endsWith('/api/authenticate') &&
                ...
                if (body.email === 'shan@domain.com' && body.password === '1234') {
